...
navbarMenu("Methods",
           ...
           tabPanel("Intervention Analysis",
                    ...
                    img(src="events_table.png", width="50%", height="50%"),
           ...
           tabPanel("Time Series Clustering",
                    ...
                    img(src="clust_parameters.png", width="65%", height="65%"),
           ) # tabPanel
), # navbarMenu
...
navbarMenu("Analysis",
           ...
           tabPanel("Time Series",
            ...
            tabPanel("Intervention Analysis",
                     ...
                     img(src="impact_analysis.png", width="50%", height="50%"),
            ...
            tabPanel("Dendrogram",
                     ...
                     img(src="app_dendrograms.png", width="75%", height="75%"),
                     h3("LPR Dataset"),
                     img(src="lpr_dendrograms.png", width="75%", height="75%"),
                     h3("Naturalization Dataset"),
                     img(src="nat_dendrograms.png", width="75%", height="75%"),
                     h3("Nonimmigrant Dataset"),
                     img(src="non_dendrograms.png", width="75%", height="75%"),
            ),
            ##### TAB: Prototypes #####
            tabPanel("Prototypes",
                     ##### Prototypes #####
